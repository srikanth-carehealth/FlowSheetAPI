...
namespace FlowSheetAPI.Migrations
{
    ...
    [Migration("20240115172602_FlowSheetTemplateSchemachangeforDisplayOrder")]
    partial class FlowSheetTemplateSchemachangeforDisplayOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlowSheetAPI.DomainModel.LabItem", b =>
                {
                    b.Property<Guid>("LabItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("lab_item_id");
                    ...
                    b.Property<string>("LabItemCode")
                        .HasColumnType("text")
                        .HasColumnName("lab_item_code");

                    b.Property<string>("LabItemName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("lab_item_name");
            ...
            modelBuilder.Entity("FlowSheetAPI.DomainModel.LabItemSpeciality", b =>
                {
                    b.Property<Guid>("LabItemSpecialityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("lab_item_speciality_id");
                    ...
                    b.Property<Guid>("lab_item_id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("specialityType_id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("speciality_contition_type_id")
                        .HasColumnType("uuid");

                    b.HasKey("LabItemSpecialityId");

                    b.HasIndex("lab_item_id");

                    b.HasIndex("specialityType_id");

                    b.HasIndex("speciality_contition_type_id");

                    b.ToTable("LabItemSpeciality");
                });
            ...
            modelBuilder.Entity("FlowSheetAPI.DomainModel.SpecialityConditionType", b =>
                {
                    ...
                    b.Property<string>("SpecilityConditionCode")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("speciality_condition_code");
            ...
            modelBuilder.Entity("FlowSheetAPI.DomainModel.LabItemSpeciality", b =>
                {
                    b.HasOne("FlowSheetAPI.DomainModel.LabItem", "LabItem")
                        .WithMany()
                        .HasForeignKey("lab_item_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("FlowSheetAPI.DomainModel.SpecialityConditionType", "SpecialityConditionType")
                        .WithMany()
                        .HasForeignKey("speciality_contition_type_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
